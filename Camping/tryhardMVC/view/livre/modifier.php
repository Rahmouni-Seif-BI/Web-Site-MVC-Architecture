...
$livres=$livre->all(); 
    ...
    ?>
        ...
        <tr>
            <td>Marque</td> <td><input type="text" name="marque" value="<?php echo $v->get('marque')?>"></td>
        </tr>
        <tr>
            <td>Descreption</td> <td><input type="text" name="descreption" value="<?php echo $v->get('descreption')?>" ></td>
        </tr>
        <tr>
            <td>Prix</td> <td><input type="text" name="prix" value="<?php echo $v->get('prix')?>"></td>
        </tr>
        <tr>
            <td>Stock</td> <td><input type="text" name="stock" value="<?php echo $v->get('stock')?>"></td>
        </tr>
        <tr>
            <td>Vendue</td> <td><input type="text" name="vendue" value="<?php echo $v->get('vendue')?>"></td>
        </tr>
        <tr>
