...
foreach ($users  as $v ) 
{
    ...
    <td><a href="user.php?action=formupdateUser&cin=<?php echo $v->get('cin')?>">modifier</a> </td>

    <td><a href="index.php?action=deleteUser&cin=<?php echo $v->get('cin')?>">supprimer</a> </td>
 </tr>
<?php   
}
