...
<html lang="fr">
    ...
    <form method="POST" action="index.php?action=ajouter&controlleur=Livre">
	...
	<table >
        ...
        <tr>
            <td>nomproduit</td> <td><input type="text" name="nomproduit"></td>
        </tr>
        <tr>
            <td>nomclient</td> <td><input type="text" name="nomclient"></td>
        </tr>
