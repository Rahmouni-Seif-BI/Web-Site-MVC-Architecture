...
<html lang="fr">
    ...
    <form method="POST" action="index.php?action=save&controlleur=Livre">
	...
	<table >
        ...
        <tr>
            <td>Descreption</td> <td><input type="text" name="descreption"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Vendue</td> <td><input type="text" name="vendue"></td>
        </tr>
        <tr>
