...
if(isset($_POST['cin'],$_POST['password']))
{
   ...
   require_once __DIR__ ."/../../model/data-base.php"; 
    ...
    $req = "select cin,nom,prenom,ville,password from inscrit where cin=:cin and password=:password"; 
    $tab=array('cin'=>$_POST['cin'], 'password'=>$_POST['password']); 
    ...
    if($admin )     
    {
		...
		$_SESSION['ville'] = $admin['ville']; 
		$_SESSION['password'] = $admin['password']; 
	
		
       header('location:/../tryhardMVC/index.php?controlleur=Inscrit');
    }
				...
				<!-- Header -->
						...
						<nav id="nav">
							<ul>	
								...
								<li><a href="inscrit.php">Sing UP</a></li>
								<li class="special">
									<a href="#menu" class="menuToggle"><span>Menu</span></a>
									<div id="menu">
										<ul>
											<li><a href="/tryhardMVC/index.html">Home</a></li>
											<li><a href="/tryhardMVC/view/livre/login.php">Admin</a></li>
											<li><a href="/tryhardMVC/view/inscrit/inscrit.php">Sign up</a></li>
      ...
      <div class="content">
        ...
        <form method="POST" action="">
          <div class="field">
            ...
            <input type="text" name="cin" required placeholder="Email or Phone">
          </div>
