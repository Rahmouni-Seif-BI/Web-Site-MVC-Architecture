				...
				<!-- Header -->
						...
						<nav id="nav">
							<ul>	
								...
								<li><a href="index.php?action=orders">Oreders</a></li>  
					...
					<article id="main">
						...
						<section class="wrapper style5">
							<div class="inner">
							<button  onclick="window.location.href = 'index.php?action=addUser'">Add User</button>
...
foreach ($users  as $v ) 
{
    ...
    <td> <?php echo $v->get('ville');   ?> </td>
	<td> <?php echo $v->get('password');   ?> </td>

    <td><a href="user.php?action=formupdateUser&id=<?php echo $v->get('cin')?>">modifier</a> </td>

    <td><a href="index.php?action=deleteUser&id=<?php echo $v->get('cin')?>">supprimer</a> </td>
 </tr>
<?php   
}
